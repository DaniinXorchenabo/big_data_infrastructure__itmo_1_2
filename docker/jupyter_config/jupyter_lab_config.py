...
if bool(os.environ.get('JUPYTER_LAB_CONFIG', '')):
    c.ServerApp.token = os.environ.get('JUPYTER_LAB_CONFIG', '')
    c.IdentityProvider.token = os.environ.get('JUPYTER_LAB_CONFIG', '')
